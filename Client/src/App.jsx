...
function App() {
  ...
  const handleStartGame = () => {
    // Simulate game completion with a random score for demo
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-100 via-green-50 to-blue-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 right-20 text-4xl opacity-15 animate-pulse">🌴</div>
        ...
        <div className="absolute bottom-60 right-1/3 text-4xl opacity-15 animate-bounce delay-700">🥚</div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-emerald-700 font-medium max-w-2xl mx-auto leading-relaxed">
              Jump, run, and survive in the ultimate prehistoric adventure!
              Test your reflexes in this thrilling dinosaur survival game.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center space-y-12 lg:space-y-0 lg:space-x-16 mb-16">
            ...
            <div className="order-3 lg:order-3 bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-emerald-200">
              <h3 className="text-xl font-bold text-emerald-800 mb-4 text-center">Game Stats</h3>
              <div className="space-y-3 text-emerald-700">
                <div className="flex justify-between items-center">
                  <span className="font-medium">Games Played:</span>
                  <span className="font-bold">{highestScore > 0 ? '1+' : '0'}</span>
                </div>
                <div className="flex justify-between items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-emerald-200 hover:shadow-xl transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-lg font-bold text-emerald-800 mb-2 text-center">Lightning Fast</h3>
              <p className="text-emerald-600 text-center">Responsive controls for the ultimate gaming experience</p>
            </div>
            
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-emerald-200 hover:shadow-xl transform hover:scale-105 transition-all duration-300">
              <div className="text-4xl mb-4 text-center">🏆</div>
              <h3 className="text-lg font-bold text-emerald-800 mb-2 text-center">Competitive</h3>
              <p className="text-emerald-600 text-center">Compete with players worldwide on the leaderboard</p>
            </div>
            
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-emerald-200 hover:shadow-xl transform hover:scale-105 transition-all duration-300">
              <div className="text-4xl mb-4 text-center">🎮</div>
              <h3 className="text-lg font-bold text-emerald-800 mb-2 text-center">Addictive</h3>
              <p className="text-emerald-600 text-center">Simple to learn, impossible to master gameplay</p>
            </div>
          </div>
        </div>
      </main>
